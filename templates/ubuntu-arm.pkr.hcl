...
source "qemu" "custom_image" {
    ...
    iso_urls        = [
        ...
        "https://cdimage.ubuntu.com/releases/${var.ubuntu_version}/release/${var.ubuntu_iso_file}"
        ]
    iso_checksum    = "file:https://cdimage.ubuntu.com/releases/${var.ubuntu_version}/release/SHA256SUMS"
    iso_target_path = "iso"
